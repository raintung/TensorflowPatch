...
JNIEXPORT jobject JNICALL Java_org_tensorflow_SavedModelBundle_load(
	...
	return Java_org_tensorflow_SavedModelBundle_load2(env, clazz, export_dir, tags, run_options, nullptr);
}


JNIEXPORT jobject JNICALL Java_org_tensorflow_SavedModelBundle_load2(
    JNIEnv* env, jclass clazz, jstring export_dir, jobjectArray tags,
